 ...
 */
@WebServlet(name = "BusquedaCarreraServlet", urlPatterns = {"/estudiantes/busqueda/carrera"})
public class BusquedaCarreraServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("termino", "carrera");
        req.setAttribute("ejemplo", "Sistemas");
        ...
        if(q != null) {
            ...
            port.alumnosInscritosPorCarrera(q, alumnos, error);
